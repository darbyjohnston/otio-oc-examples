    ...
    if 'Shot' == child.tag:
        for child2 in child:
            if 'Record' == child2.tag:
                ...
                clip.media_reference.name_prefix = "SPARKS_HDR10_4K_2020_PQ_1000nits_"
                clip.media_reference.name_suffix = ".tif"
...
otio.adapters.write_to_file(timeline, 'SPARKS_HDR10_4K_2020_PQ_1000nits.otio')
